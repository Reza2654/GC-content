...
def show_about_info():
    about_info = """
    This software was created by Reza Bagheri.
    Version: 2.1
    Date: 2023-10-05
    """
...
window.geometry("300x183")  # تنظیم اندازه اولیه پنجره به عنوان مثال 300x200 پیکسل
window.resizable(False, False)  # غیرقابل تغییر اندازه پنجره
...
about_button = tk.Button(window, text="About", command=show_about_info)
