...
window.geometry("330x330")  # تنظیم اندازه اولیه پنجره به عنوان مثال 330x330 پیکسل
...
about_button = tk.Button(window, text="About", command=show_about_info, bg="Gray")  # تنظیم رنگ آبی
